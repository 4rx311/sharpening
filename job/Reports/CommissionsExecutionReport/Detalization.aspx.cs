...
namespace WSSC.V4.DMS.OMK.Reports
{
    ...
    /// </summary>
    public class Detalization : Page
    {
        #region controls
        ...
        /// <summary>
        /// Название из PublishingReportSetting
        /// </summary>
        protected virtual string ReportSettingsName
        {
            get
            {
                return _Consts.Reports.CommissionsExecutionReport.PublishingParam;
            }
        }
        ...
        public RPPublishingBuilder PublishingBuilder
        {
            get
            {
                if (!__init_PublishingBuilder)
                {
                    ...
                    RPSettings reportSettings = reportProvider.GetReportSettings(this.ReportSettingsName);
